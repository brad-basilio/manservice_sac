...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-[100vh] flex items-center pt-20 overflow-hidden">
      ...
      >
        <img 
          src="https://picsum.photos/seed/industrial-boiler/1920/1080?blur=2" 
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="max-w-4xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-6 shadow-lg shadow-black/20">
              <span className="w-2 h-2 rounded-full bg-brand-secondary animate-pulse shadow-[0_0_8px_rgba(217,39,42,1)]"></span>
              <span className="text-white/90 text-sm font-semibold tracking-wider">ESTÁNDAR INTERNACIONAL</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-2xl font-sans leading-relaxed drop-shadow-md">
              +30 años diseñando y fabricando equipos generadores de vapor certificados ASME para la industria peruana.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6 md:gap-12 border-t border-white/20 pt-8 mt-auto">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white font-bold font-heading text-lg leading-tight">Certificación ASME</div>
                  <div className="text-white/70 text-sm">Estándar global garantizado</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white/10 backdrop-blur p-3 rounded-full shrink-0">
                ...
                <div>
                  <div className="text-white font-bold font-heading text-lg leading-tight">+500 Proyectos</div>
                  <div className="text-white/70 text-sm">Casos de éxito industriales</div>
                </div>
              </div>
            </div>
          </motion.div>
