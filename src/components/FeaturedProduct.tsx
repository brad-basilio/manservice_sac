...
export default function FeaturedProduct() {
  ...
  return (
    <section
      ref={ref}
      className="relative h-[85vh] min-h-[600px] overflow-hidden flex items-center justify-center"
    >
      {/* Parallax Background */}
      <motion.div
        style={{ y }}
      ...
      >
        ...
        <h2 className="text-4xl text-white md:text-6xl lg:text-7xl font-heading font-black mb-6 leading-tight drop-shadow-2xl">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-12 font-light leading-relaxed">
          Diseñados para la industria pesada. Máxima eficiencia térmica, bajo
          consumo de combustible y construcción robusta con acero estructural
          bajo estricta certificación ASME.
        </p>
